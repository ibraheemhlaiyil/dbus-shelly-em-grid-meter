...
```
wget https://github.com/ibraheemhlaiyil/dbus-shelly-em-grid-meter/archive/refs/heads/main.zip
unzip main.zip "dbus-shelly-em-grid-meter-main/*" -d /data
mv /data/dbus-shelly-em-grid-meter-main /data/dbus-shelly-em-grid-meter
chmod a+x /data/dbus-shelly-em-grid-meter/install.sh
/data/dbus-shelly-em-grid-meter/install.sh
rm main.zip
```
